...
public class clsTest4 {
	...
	public static void main(String[] args) {
		...
		int value =-1; int minInteger = -5; int maxInteger = 5; int position = -1;
		int iterations = 0; int maximum =50; String cadena="";
		
		ArrayList<Object> objAuxiliar = new ArrayList<Object>();	
		int maxSize=5;
		clsIntegerRDList objLista = new clsIntegerRDList(maxSize); // instancia para comenzar
        ...
        do {
        	...
        	switch (option) {
	            case 0:
	            	/*
	            	objLista = new clsIntegerRDList(maxSize);
